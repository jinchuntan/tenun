...
export const demoProfile: UserProfile = {
  ...
  education:
    "BSc Computer Science, University of Melbourne (Expected 2025). Minor in Environmental Studies. Dean's List 2023.",
  experience:
    "Data Analytics Intern at Deloitte (6 months) — built dashboards for ESG reporting. University Consulting Club — led a 5-person team for a pro-bono strategy project with a climate-tech startup. Won 2nd place at GreenHack 2024 hackathon for a carbon footprint tracker app. Volunteer coordinator for Youth Climate Action Network.",
  skills: [
    "Python",
    "SQL",
    "Figma",
  ...
  salaryExpectation: "$70,000 - $90,000 AUD",
  riskAppetite: "medium",
  lifestylePreference: "flexibility",
  locationPreference: "Melbourne, Sydney, Singapore, or Remote",
