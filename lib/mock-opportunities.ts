...
export const mockOpportunities: Opportunity[] = [
  ...
  },
  {
    ...
    description:
      "Analyze climate policy data and build models to support Australia's transition to net-zero emissions. Collaborate with researchers and government stakeholders.",
  ...
  {
    id: "opp-4",
    title: "Sustainability Tech Accelerator",
    type: "internship",
  ...
  },
  {
    ...
    matchPercentage: 85,
    whyMatch:
      "Fills skill gaps in advanced analytics techniques and adds a recognized credential to strengthen your data career path.",
    skillsDeveloped: [
    ...
    description:
      "Industry-recognized certificate covering the entire data analytics lifecycle. Includes hands-on projects and portfolio pieces.",
  ...
  },
  {
    ...
    matchPercentage: 92,
    whyMatch:
      "Combines your strongest skills (Python, data visualization, Figma) with your deepest interest (climate tech). Creates a standout portfolio piece.",
    skillsDeveloped: [
    ...
    description:
      "Build an open-source dashboard visualizing real-time climate data from public APIs. Design the UI in Figma, implement with Python/React, and deploy on Vercel.",
    duration: "4-6 weeks",
  },
  {
    id: "opp-8",
    ...
    description:
      "Create three detailed product case studies analyzing real products. Include market analysis, user research findings, feature proposals, and mockups.",
    duration: "3-4 weeks",
  },
  {
    id: "opp-9",
  ...
  },
  {
    ...
    description:
      "Build a tool that helps organizations measure and report their sustainability metrics. Top submissions win prizes and mentorship from industry leaders.",
    duration: "48 hours",
  },
  {
    id: "opp-12",
