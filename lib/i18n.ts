...
const en = {
  ...
  cvUpload: {
    ...
    parsingSteps: ["Reading your CV", "Mapping your threads", "Weaving your pathways"],
...
const ms: Translations = {
  ...
  cvUpload: {
    ...
    parsingSteps: ["Membaca CV anda", "Memetakan benang anda", "Menenun laluan anda"],
...
const zhCN: Translations = {
  ...
  cvUpload: {
    ...
    parsing: "正在解析 {name}……",
    parsingSteps: ["正在读取你的简历", "正在梳理你的脉络", "正在编织你的路径"],
