        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-navy-300 text-sm mb-5 max-w-md mx-auto leading-relaxed">
              Upload your CV and we&apos;ll show your personalised skill gap, match score,
              and get you in front of companies hiring for{" "}
            ...
            {userEmail ? (
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <button
                  onClick={handleContinue}
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 text-white border border-white/20 rounded-xl text-sm font-medium hover:bg-white/20 transition-all"
                >
                  Upload CV without signing in
                  <ArrowRight className="w-4 h-4" />
                </button>
              </div>
            )}
